...
class MainWindow(QMainWindow):
    ...
    def _animate_transition_to_widget(self, new_widget):
        ...
        if current_widget is not None:
            # si no los importo aqui no funciona wtf
    ...
    def _setup_sidebar_buttons(self):
        ...
        for key, (text, permission_id, icon_name) in self.button_map.items():
            ...
            btn.clicked.connect(
                lambda checked, k=key: self._switch_view(k, checked))
    ...
    def _setup_user_info(self):
        ...
        user_info_layout.setContentsMargins(0, 0, 10, 0)
    ...
    def _apply_role_permissions(self):
        ...
        required_permissions = ROLES_PERMISSIONS.get(
        ...
        for key, btn in self.buttons.items():
            ...
            if permission_id in required_permissions:
                ...
                btn.hide()
                print(
                    f"INFO: Botón '{key}' deshabilitado para rol '{self.current_user_role}'.")
